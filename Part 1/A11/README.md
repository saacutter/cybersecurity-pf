...
Although not a traditional application, two factor authentication systems using one time passwords generated by mobile devices are a form of mobile access control. These credentials are created using QR codes (or a key of some sort). \
<img src="access_control_mobile_2fa.png" height="400" style="display: block; margin: 0 auto;">

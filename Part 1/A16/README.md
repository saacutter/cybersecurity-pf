...
Note that although the Qantas cyberattack did not technically occur in Western Australia so it could be argued that it is not a "local" security incident, it did involve data from Western Australians which is why it was chosen to complete this particular activity.

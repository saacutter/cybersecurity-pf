...
Evidence for this activity was hard to get. Taking photos of the pieces of paper would not realistically prove anything, nor would taking a photo of me in the room (though I have provided one from the date which should have EXIF data for the date and time of the lab). This write-up is intended to act as evidence, as it would be impossible to know what happened in the lab nor write about a process without having attended this lab.

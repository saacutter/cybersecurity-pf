...
this portfolio, the following prompt was given to ChatGPT 5.3:
\textgreater{} Generate me an image which showcasing what you believe a
``hacker'' looks like.

This resulted in the following image being generated, which will serve
as the ``base'' image for all processes: \includegraphics{base.png}

The full conversation is available
\href{https://chatgpt.com/share/69f60423-165c-8320-8f46-5292baad4ccb}{here}.

\hypertarget{steganography}{%
\subsection{Steganography}\label{steganography}}
...
following image. \includegraphics{tests/steganography/watermarked.png}
...
5.3}) if it can regenerate the image providing it as an attachment. This
...
\includegraphics{tests/metadata/base_verification.png}
...
will be copied. The full conversation to perform this is available
\href{https://chatgpt.com/share/69f80f34-aa4c-839c-9cc0-355989639de1}{here},
with the image saved as \texttt{regenerated.png}.
\includegraphics{tests/metadata/regenerated_verification.png}
...
\texttt{cropped.png}.
\includegraphics{tests/metadata/cropped_verification.png}
